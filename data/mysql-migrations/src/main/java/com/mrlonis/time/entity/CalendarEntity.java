 ...
 *
 * <p>This is done to show that the {@link Calendar java.util.Calendar} data type is compatible with MySQL's TIMESTAMP
...
@NoArgsConstructor
@SuperBuilder
public class CalendarEntity extends BaseEntity<Calendar> {}
