...
ALTER TABLE pr_url ADD CONSTRAINT fk_todo_items_on_pr_url FOREIGN KEY (todo_item_id) REFERENCES todo_items (id);
...
ALTER TABLE testing_url ADD CONSTRAINT fk_todo_items_on_testing_url FOREIGN KEY (todo_item_id) REFERENCES todo_items (id);
